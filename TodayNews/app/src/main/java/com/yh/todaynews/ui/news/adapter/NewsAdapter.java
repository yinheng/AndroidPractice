...
import com.yh.todaynews.ui.common.WebViewActivity;
...
public class NewsAdapter extends PaginationAdapter<News> {
    ...
    public List<News> getNextPageNews(int position, int pageSize) {
        NewsPageViewModel newsPageViewModel = new NewsPageViewModel(activity);
        return newsPageViewModel.getNextPage(position, pageSize);
    }
}
