...
public class TweetsService {
    ...
    public TweetsService() {
        String BASE_URL = "http://thoughtworks-ios.herokuapp.com/user/";
    ...
    public User getUser() {
        User user = null;
        Call<User> call = tweetsApi.getUser();
        try {
            ...
            e.printStackTrace();
            Log.e("TweetsService", "getUser : " + e.getMessage());
        }
        return user;
    }
    ...
    public List<Tweet> getTweetList() {
        ...
        Call<List<Tweet>> call = tweetsApi.getTweetList();
        try {
                ...
                if (tweetList != null) {
                    for (Tweet tweet : tweetList) {
                        if(!(tweet.getContent() == null && tweet.getSender() == null && tweet.getComments() == null)){
                            Sender sender = mockSenderAvatar(tweet.getSender());
                            tweet.setSender(sender);
                            tweet.setImages(mockImages());
                        }
                    }
                }
            }
            ...
            e.printStackTrace();
            Log.e("TweetsService", "getTweetList : " + e.getMessage());
        }
        return tweetList;
    }

    private static Sender mockSenderAvatar(Sender sender){
        sender.setAvatar("https://img.tukuppt.com/ad_preview/00/15/72/5e900b62c12ef.jpg!/fw/980");
        return sender;
    }
